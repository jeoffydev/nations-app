...
class AddCategory extends Form{
    ...
    doSubmit = () =>{
        ...
        if(data){
                    ...
                    axiosApiInstance.post(apiEndPoint('add-category'),  data)  
                    .then(response => {
    ...
    render(){  
        ...
        return ( 
            <React.Fragment> 
                    ...
                    <AddButton idname="AddCategory" id="cat" label="Add Category"  /> 

                    {/* Passwrd Modal here */} 
                    <div className="modal fade" id="AddCategoryModalcat" tabIndex="-1" role="dialog" aria-labelledby="popModalLabel" aria-hidden="true">
                        <div className="modal-dialog" role="document">
                            <div className="modal-content"> 

                                <div className="modal-body"> 

                                    <PopupHeader idname="category" label="Add category" />  
